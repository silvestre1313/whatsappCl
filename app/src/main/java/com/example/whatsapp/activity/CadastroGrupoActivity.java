        ...
        if (resultCode == RESULT_OK){
            ...
            try {
                ...
                if (imagem != null){
                    ...
                    uploadTask.addOnFailureListener(e -> Toast.makeText(CadastroGrupoActivity.this, "Erro ao fazer upload da imagem", Toast.LENGTH_SHORT).show()).addOnSuccessListener(taskSnapshot -> {
